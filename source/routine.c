...
/*   Updated: 2025/09/09 14:02:50 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_action(t_philo *philo, const char *action)
{
    ...
    // If a philosopher has already died, don't print anything
    if (program->death_flag)
        return;

    // Lock the print mutex to avoid overlapping prints
...
//     sleep_monitor(100, philo->program); // optional small think duration
// }
void to_think(t_philo *philo)
{
    t_program *program = philo->program;
    ...
    sleep_monitor(50, program); // small think pause
}
